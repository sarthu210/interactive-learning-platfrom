...
export default function Register() {
  ...
  const onSubmit = async (data) => {
    try {
      const response = await axios.post('https://backend-fy8xpobzy-sarthu102-gmailcoms-projects.vercel.app/auth/register', data, { withCredentials: true });
  ...
  return (
    ...
    <div className='min-[1080px]:flex max-[750px]:flex-wrap max-[750px]:p-3 max-[750px]:mb-14 lg:flex-nowrap flex-row justify-evenly border rounded-lg'>
      ...
      <label htmlFor="email">Name:</label>
        ...
        <p className='text-black mt-2'>If not already register? <a onClick={gotoLogin} className='text-red-600 cursor-pointer'>login here</a></p>
      </form>
    </div>
