...
export default function Quize(props){
    ...
    const createQuize = async () => {
        ...
        try {
            ...
            const response = await axios.post('https://backend-fy8xpobzy-sarthu102-gmailcoms-projects.vercel.app/api/generate-quize', { name: props.level }, {withCredentials: true});
